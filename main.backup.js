...
button.addEventListener('click', delayCall.bind(null, autosolver.solveNext, 100));
...
function delayCall(func, delayMs = 0){
    setTimeout(() => {func(); delayCall(func, delayMs)}, delayMs)
}
